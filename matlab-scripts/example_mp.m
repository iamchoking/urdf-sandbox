...
% define Lagrangian
r1_tip = [l1*sin(th1);-l1*cos(th1)];
r1     = beta1*r1_tip;
r2 = r1_tip + beta2*[l2*sin(th1+th2);-l2*cos(th1+th2)];

v1_tip = [l1*cos(th1)*om1;l1*sin(th1)*om1];
v1     = beta1*v1_tip;
v2 = v1_tip + beta2*[l2*cos(th1+th2)*(om1+om2);l2*sin(th1+th2)*(om1+om2)];
